...
loadstring(game:HttpGet("https://raw.githubusercontent.com/JustLevel/Nowayt/main/AntiStaff.lua"))()
...
while getgenv().autoChest do
    ...
    if not getgenv().autoChestConfig.SERVER_HOP then
        ...
        loadstring(game:HttpGet("https://raw.githubusercontent.com/JustLevel/Nowayt/main/SHOP.lua"))()
    end
end
